...
import com.dan.locks.TestAndSetLock;
...
public class TestAndSetLockTest {
    ...
    public void testCounterWithBakeryLock() throws InterruptedException {
        TestAndSetLock testAndSetLock = new TestAndSetLock();
        LockCounter lockCounter = new LockCounter(testAndSetLock);
        Thread thread1 = new Thread(lockCounter::increment);
        Thread thread2 = new Thread(lockCounter::increment);
